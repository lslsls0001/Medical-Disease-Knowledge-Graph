...
class QuestionClassifier:
    def __init__(self):
        #　特征词路径
        self.disease_path = './dict/disease.txt'
        self.department_path = './dict/department.txt'
        self.check_path = './dict/check.txt'
        self.drug_path = './dict/drug.txt'
        self.food_path = './dict/food.txt'
        self.producer_path = './dict/producer.txt'
        self.symptom_path = './dict/symptom.txt'
        self.deny_path = './dict/deny.txt'
        ...
        # 建树 加快检索  可参考ahocorasick的使用  进行学习  actree
